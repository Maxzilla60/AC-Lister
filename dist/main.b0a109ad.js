...
},{}],"src/views/profile.view.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(ProfileView, null, [{
    ...
    value: function updateListSelect() {
      var selectedListId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : state_service_1.stateService.currentListSelect;
      ...
      try {
        for (var _iterator = state_service_1.stateService.getLists()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          util_1.getElement('list_select').appendChild(this.aListDropdownOption(list, list.id === selectedListId));
        }
      } catch (err) {
    ...
    value: function anAddOrRemoveElement() {
      var addOrRemoveElement = document.createElement('div');
    ...
    value: function aWikiIconButton(wikiLink) {
      var wikiIconButton = document.createElement('button');

      wikiIconButton.onclick = function () {
    ...
    value: function aStoreIconButton(storeLink) {
      var storeIconButton = document.createElement('button');

      storeIconButton.onclick = function () {
    ...
    value: function aSpeciesIcon() {
      var speciesIcon = document.createElement('i');
    ...
    value: function aPersonalityIcon() {
      var personalityIcon = document.createElement('i');
    ...
    value: function aBirthdayButton(villagerName) {
      var birthdayEasterEggButton = document.createElement('button');
      birthdayEasterEggButton.title = "Happy birthday to ".concat(villagerName, "!");

      birthdayEasterEggButton.onclick = function () {
    ...
    value: function anAddVillagerToListButton() {
      ...
      var addVillagerToListButton = document.createElement('button');

      addVillagerToListButton.onclick = function () {
        main_1.addVillager(state_service_1.stateService.currentLoadedProfileId, util_1.getListSelectValue());
      };
    ...
    value: function aRemoveVillagerFromListButton() {
      var removeVillagerFromListButton = document.createElement('button');

      removeVillagerFromListButton.onclick = function () {
        main_1.removeVillager(state_service_1.stateService.currentLoadedProfileId, util_1.getListSelectValue());
      };
...
},{"../main":"src/main.ts","../util/state.service":"src/util/state.service.ts","../util/util":"src/util/util.ts"}],"src/views/lists.view.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(ListsView, null, [{
    ...
    value: function updateListEditingButtons() {
      var exportListsButton = util_1.getElement('export_lists');
      var clearListsButton = util_1.getElement('clear_lists');
    ...
    value: function aListTitleElement(list) {
      var listTitleElement = document.createElement('button');

      listTitleElement.onclick = function () {
    ...
    value: function aListRenameButton(list) {
      var listRenameButtonElement = document.createElement('button');

      listRenameButtonElement.onclick = function () {
        main_1.renameList(list.id);
      };
    ...
    value: function aVillagerListIconsSection(list) {
      var villagerIconsSection = this.aDividerElement();
      var _iteratorNormalCompletion2 = true;
      var _didIteratorError2 = false;
      var _iteratorError2 = undefined;

      try {
        for (var _iterator2 = list.members[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function aVillagerListIcon(villager, listId) {
      var villagerListIcon = document.createElement('img');

      villagerListIcon.onclick = function () {
        main_1.loadProfile(villager, listId);
      };

      villagerListIcon.title = util_1.trimName(villager);
      villagerListIcon.src = "./villager_icons/".concat(villager, ".gif");
      return villagerListIcon;
    }
  }, {
    key: "anEmptyListInfoElement",
    value: function anEmptyListInfoElement() {
      var emptyListInfoElement = document.createElement('div');
    ...
    key: "aDividerElement",
    value: function aDividerElement() {
    ...
    value: function aListTitleInputElement(list) {
      ...
      listTitleInputElement.onchange = function () {
        main_1.applyTitle(list.id, _this.getRenameListTitleValue());
      };
    ...
    value: function aListRenameConfirmButton(list) {
      ...
      listRenameButtonElement.onclick = function () {
        main_1.applyTitle(list.id, _this2.getRenameListTitleValue());
      };
...
},{"../main":"src/main.ts","../util/state.service":"src/util/state.service.ts","../util/util":"src/util/util.ts","./profile.view":"src/views/profile.view.ts"}],"src/views/search.view.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(SearchView, null, [{
    ...
    value: function aVillagerSearchResultButton(villager) {
      var villagersSearchResultButton = document.createElement('button');

      villagersSearchResultButton.onclick = function () {
        main_1.loadProfile(villager.id);
      };
    ...
    value: function aVillagersSearchResultNameElement(villagerName) {
      var villagersSearchResultNameElement = document.createElement('div');
    ...
    value: function aVillagersSearchResultImage(villager) {
      var villagersSearchResultImage = document.createElement('img');
      villagersSearchResultImage.alt = villager.name;
      villagersSearchResultImage.style.cssFloat = 'left';
      villagersSearchResultImage.src = "./villager_icons/".concat(villager.id, ".gif");
...
},{"../main":"src/main.ts","../util/util":"src/util/util.ts","../util/villagers.json":"src/util/villagers.json"}],"node_modules/file-saver/dist/FileSaver.min.js":[function(require,module,exports) {
var define;
...
exports.updateAddVillagerButton = updateAddVillagerButton; // TODO
...
exports.getVillagersWhosBirthdayIsToday = getVillagersWhosBirthdayIsToday;
...
exports.percentageOfVillagersWithProfileImage = percentageOfVillagersWithProfileImage;
...
exports.init = init;
},{"./util/state.service":"src/util/state.service.ts","./util/util":"src/util/util.ts","./util/villagers.json":"src/util/villagers.json","./views/lists.view":"src/views/lists.view.ts","./views/profile.view":"src/views/profile.view.ts","./views/search.view":"src/views/search.view.ts","file-saver":"node_modules/file-saver/dist/FileSaver.min.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/main.ts"], "index")
